...
| Problem | Solution |
|---------|----------|
| **No data loaded** | Run `python fetch_data_csv.py` to create data file |
| **Chatbot not working** | Check `utils/.env` has valid `GEMINI_API_KEY` |
| **"Invalid API key" error** | Get new key from Google AI Studio and update .env |
| **Sections 2/3 show error** | Ensure `data/sp500_data.csv` exists |
| **Charts not showing** | Click "Refresh Data" button in sidebar |
| **Port already in use** | Run with different port: `streamlit run app.py --server.port 8502` |
| **Module not found** | Install dependencies: `pip install -r requirements.txt` |
| **Chatbot responses white** | Update browser or clear cache (Ctrl+Shift+R) |
...
- Understand market metrics
- Practice investment decisions risk-free
...
- Request explanations of indicators
- Inquire about strategies
- Get clarification on metrics
...
**Disclaimer**: This tool does not provide financial, investment, or trading advice. Always consult with qualified financial advisors before making investment decisions.
...
2. Review the chatbot error messages (they provide solutions)
...
*Remember: This dashboard is a tool for learning and analysis. Always do thorough research and consult professionals before making financial decisions.*
